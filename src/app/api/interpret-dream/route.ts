...
ALL sentences across every field must consistently end with "~입니다" or "~합니다" without exception. Never use "~해요", "~네요", "~죠", or any other endings.`;
    ...
    // 키워드 볼드 처리 규칙
    const boldRule = `For important keywords that carry symbolic meaning, wrap them with ** like **단어** only in analysis, so they appear bold.`;
...

{
  ...
  "goodElements": "2 sentences about specific fortunate signs in this dream and what they mean for the dreamer. Bold key words.",
  "badElements": "2 sentences about specific cautionary signs and what to be mindful of. Bold key words."
}
